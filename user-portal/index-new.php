...
<head>
    ...
    <script src="../assets/js/therapist-data.js?v=20260131"></script>
</head>
<body>
    <!-- ヘッダーコンポーネント -->
    ...
    <!-- Therapists Section -->
    <section id="therapists" class="therapists">
        <div class="container">
            <div class="section-title">
                <h2>セラピスト紹介</h2>
                <p>経験豊富な専門家たちがあなたの癒しをサポートします</p>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            try {
                ...
                therapistsGrid.innerHTML = '<div style="text-align: center; padding: 40px; color: #999;">セラピストデータの読み込みに失敗しました</div>';
            }
        });
    </script>
    ...
    <section id="contact" class="contact">
        <div class="container">
            <div class="section-title">
                <h2>お問い合わせ</h2>
                <p>ご質問やご不明点がありましたら、お気軽にお問い合わせください</p>
            </div>
